...
//   return (
//     // ✅ id yahan lagaya — Navbar ke scroll target ke liye
...
//                       <a className="instant-book-btn" href={current.bookingUrl} onClick={(e) => e.stopPropagation()}>
...
//                       <a className="instant-book-btn-ghost" href={v.bookingUrl} onClick={(e) => e.stopPropagation()}>⚡ Instant Booking</a>
//                     </div>
...
//                       <a className="instant-book-btn" href={v.bookingUrl} onClick={(e) => e.stopPropagation()} style={{ fontSize: "9px", padding: "9px 16px" }}>
...
//                     <a className="instant-book-btn" href={v.bookingUrl} onClick={(e) => e.stopPropagation()} style={{ fontSize: "8px", padding: "7px 12px", letterSpacing: "1.5px" }}>
//                       ⚡ Instant Booking
//                     </a>
//                   </div>
//                 </div>
...
//               </div>
//               <a className="instant-book-btn" href={playingVideo.bookingUrl} onClick={(e) => e.stopPropagation()}>
//                 <span className="bolt-icon">⚡</span>Instant Booking
//               </a>
//             </div>
//           </div>
