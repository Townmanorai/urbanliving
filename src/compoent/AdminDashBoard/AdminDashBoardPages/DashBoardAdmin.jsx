...
// //
// // Nightly (Tmx9PropertyForm) DB mein:
// //   check_in_time: "15:00:00"   ← top-level DB column (new listings)
// //   check_out_time: "11:00:00"  ← top-level DB column (new listings)
// //   property_category: "Apartment"|"House"|"Villa"|"Cabin"|"Bungalow"|
// //                      "Studio"|"Suite"|"Other"|"Hotel"
// //
// // Monthly (PGListingForm) DB mein:
// //   check_in_time: null/empty
// //   property_category: "Flat"|"PG"|"Penthouse" (PGListingForm unique categories)
// //   ya property_category kuch bhi ho sakta hai
// //
// // NIGHTLY categories (sirf Tmx9PropertyForm mein hain):
// //   Apartment, Villa, Cabin, Bungalow, Hotel
// //   (House/Studio/Suite dono mein hain — ambiguous, check_in_time pe rely karo)
// //
// // MONTHLY categories (sirf PGListingForm mein hain):
// //   Flat, Penthouse
// //   PG — dono mein hai lekin hamesha monthly
// //
// // PRIORITY ORDER:
// //   1. check_in_time filled → NIGHTLY (strongest, new data)
// //   2. property_category "Apartment"/"Villa"/"Cabin"/"Bungalow"/"Hotel" → NIGHTLY
// //   3. property_category "Flat"/"Penthouse"/"PG" → MONTHLY
...
//     }}>
//       <div style={{
//         background: '#fff', padding: '36px 40px', borderRadius: '20px',
...
//         }}>
//           {isMonthly
//             ? <Calendar size={38} style={{ color: '#fff' }} />
//             : <Moon size={38} style={{ color: '#fff' }} />}
//         </div>
...
//           {isMonthly
//             ? 'You have no monthly rental / PG properties listed yet. Start by listing your first long-term property.'
//             : 'You have no nightly rental properties listed yet. Start by listing your first short-stay property.'}
//         </p>
//         <button
//           type="button"
//           onClick={onAdd}
...
//             <span style={{
//               background: active ? tab.color : '#d1d5db',
...
//             monthlyCount={monthlyProperties.length}
//             nightlyCount={nightlyProperties.length}
//           />
...
//             <EmptyState
//               type={activeTab}
//               onAdd={() => navigate(activeTab === 'monthly' ? '/list-pg' : '/listed1')}
//             />
//           ) : (
...
function EditPropertyModal({ property, onClose, onRefresh }) {
  ...
  const [formData, setFormData] = useState({
    property_name: property.property_name || property.name || "",
    // ── FIX 1: description load karte waqt pehle se appended junk saaf karo ──
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      // ── FIX 2: description mein KUCH BHI append nahi karna ──────────────────
      // PG Details, Local Guide, [object Object] — sab band
      // description sirf user ka original text rahega
